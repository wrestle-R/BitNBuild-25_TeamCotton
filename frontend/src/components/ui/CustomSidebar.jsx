...
import { FaHatCowboy, FaHorse, FaBullseye, FaStar, FaSignOutAlt, FaUser, FaTachometerAlt, FaCog } from 'react-icons/fa';
...
const CustomSidebar = ({ isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    ...
    { icon: FaBullseye, label: 'Practice Range' },
    { icon: FaHorse, label: 'Stable' },
    { icon: FaHatCowboy, label: 'Hat Shop' },
      ...
      >
        ...
        <div className="p-4 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            <FaHatCowboy className="w-8 h-8 text-sidebar-primary flex-shrink-0" />
            {isOpen && (
              <motion.div
              ...
              >
                ...
                <p className="text-sidebar-foreground/70 text-sm">Arena</p>
              </motion.div>
            )}
          </div>
        </div>
              ...
              <li key={index} className="relative">
                ...
                <Button
                  ...
                  className={`w-full justify-start gap-3 transition-all duration-200 ${
                    ...
                    item.active 
                      ? 'bg-sidebar-accent text-sidebar-accent-foreground border border-sidebar-accent-foreground/20 shadow-sm ml-2' 
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          className="absolute -right-3 top-6 bg-sidebar border border-sidebar-border rounded-full w-6 h-6 p-0 hover:bg-sidebar-accent"
        >
          <motion.div
