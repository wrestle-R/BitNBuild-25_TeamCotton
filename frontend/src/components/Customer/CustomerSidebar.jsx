    ...
    <>
      ...
      >
              ...
              <li key={index} className="relative">
                ...
                <Button
                  ...
                  className={`w-full justify-start gap-3 transition-all duration-200 ${
                    ...
                    item.active 
                      ? 'bg-orange-100 text-orange-800 border border-orange-200 shadow-sm ml-2' 
                      : 'text-sidebar-foreground hover:text-orange-700 hover:bg-orange-50'
                  }`}
                >
                  <item.icon className={`w-5 h-5 flex-shrink-0 ${item.active ? 'text-orange-500' : ''}`} />
                  {isOpen && (
                    <motion.span
                      initial={{ opacity: 0, x: -10 }}
                      animate={{ opacity: 1, x: 0 }}
          ...
          <div className="p-4 border-b border-sidebar-border">
            {isOpen ? (
              <ThemeToggle 
                ...
                size="default"
                showLabel={true}
                className="w-full justify-start text-sidebar-foreground hover:text-orange-700 hover:bg-orange-50"
              />
            ) : (
              <div className="flex justify-center">
                <ThemeToggle 
                  variant="ghost"
                  size="sm"
                  className="text-sidebar-foreground hover:text-orange-700 hover:bg-orange-50"
                />
              </div>
            )}
          </div>
        ...
        <Button
          ...
          variant="ghost"
          size="sm"
          className="absolute -right-3 top-6 bg-sidebar border border-sidebar-border rounded-full w-6 h-6 p-0 hover:bg-orange-50"
        >
          <motion.div
